...
@testset "Linear Model ftest/loglikelihod with $dmethod method with dropcollinear=$drop" for (
dmethod, drop) in itr
...
@testset "GLM: Binomial with LogitLink link - ProbabilityWeights with $dmethod method with dropcollinear=$drop" for (
dmethod, drop) in itr
    model = glm(
        @formula(y~1 + x1 + x2),
        df,
...
@testset "GLM: Binomial with ProbitLink link - ProbabilityWeights with $dmethod method  with dropcollinear=$drop" for (
dmethod, drop) in itr
    model = glm(
        @formula(y~1 + x1 + x2),
        df,
...
@testset "GLM: Binomial with CauchitLink link - ProbabilityWeights with $dmethod method with dropcollinear=$drop" for (
dmethod, drop) in itr
    model = glm(
        @formula(y~1 + x1 + x2),
        df,
...
@testset "GLM: Gamma with LogLink link - ProbabilityWeights with $dmethod method with dropcollinear=$drop" for (
dmethod, drop) in itr
    model = glm(
        @formula(lot1~1 + u),
        clotting,
...
@testset "GLM: NegativeBinomial(2) with LogLink link - ProbabilityWeights with $dmethod method with dropcollinear=$drop" for (
dmethod, drop) in itr
    model = glm(
...
@testset "GLM: Poisson with LogLink link - ProbabilityWeights with $dmethod method with dropcollinear=$drop" for (
dmethod, drop) in itr
    model = glm(
