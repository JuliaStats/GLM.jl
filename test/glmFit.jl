...
@test sqdiffsum(coef(gm2), [-3.9899786606380734,0.0022644256521549043,0.8040374535155766,-0.6754428594116577,-1.3402038117481079,-1.5514636444657492]) < rteps

gm3 = glm(:(admit ~ gre + gpa + rank), df, Binomial(), ProbitLink());
@test_approx_eq deviance(gm3) 458.4131713833386
@test sqdiffsum(coef(gm3), [-2.3867922998680786,0.0013755394922972369,0.47772908362647015,-0.4154125854823675,-0.8121458010130356,-0.9359047862425298]) < rteps
